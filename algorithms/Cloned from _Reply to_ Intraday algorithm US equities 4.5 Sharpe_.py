...
def make_pipeline():
    ...
    #pipe = Pipeline(screen=QTradableStocksUS() & minprice & not_announced_acq_target)
    pipe = Pipeline(screen=Q1500US() & minprice & not_announced_acq_target)
    #pipe = Pipeline(screen=Q500US() & minprice & not_announced_acq_target)
...
#                           Sector.TECHNOLOGY ]
    ...
    #attach_pipeline(make_pipeline(), "QTradableStocksUS")
